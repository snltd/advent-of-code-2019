...
raise unless ADV.run!('3,9,8,9,10,9,4,9,99,-1,8', 8) == 1
raise unless ADV.run!('3,9,8,9,10,9,4,9,99,-1,8', 4) == 0
raise unless ADV.run!('3,9,7,9,10,9,4,9,99,-1,8', 4) == 1
raise unless ADV.run!('3,9,7,9,10,9,4,9,99,-1,8', 8) == 0
raise unless ADV.run!('3,3,1108,-1,8,3,4,3,99', 8) == 1
raise unless ADV.run!('3,3,1108,-1,8,3,4,3,99', 5) == 0
raise unless ADV.run!('3,3,1107,-1,8,3,4,3,99', 5) == 1
raise unless ADV.run!('3,3,1107,-1,8,3,4,3,99', 9) == 0

raise unless ADV.run!('3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9', 0) == 0
raise unless ADV.run!('3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9', 4) == 1
raise unless ADV.run!('3,3,1105,-1,9,1101,0,0,12,4,12,99,1', 0) == 0
raise unless ADV.run!('3,3,1105,-1,9,1101,0,0,12,4,12,99,1', 1) == 1
...
raise unless ADV.run!(prog, 1) == 999
raise unless ADV.run!(prog, 8) == 1000
raise unless ADV.run!(prog, 11) == 1001
